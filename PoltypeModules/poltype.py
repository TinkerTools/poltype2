...
class PolarizableTyper():
    ...
    def GenerateDaemonInput(self,joblist,outputlogpath,scratchspacelist,ramlist,numproclist,jobpaths,inputdaemonfilepath):
        ...
        for i in range(len(joblist)):
            ...
            jobpath=jobpaths[i]
            string='--job='+job+' '+'--numproc='+str(self.numproc)+' '+'--ram='+self.maxmem+' '+'--inputfilepaths='+os.path.join(jobpath,'poltype.ini')+'\n'
            temp.write(string)
        temp.close()
