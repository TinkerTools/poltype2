        ...
        if self.poltypeini==True:
            ...
            for line in results:
                if '#' not in line and line!='\n':
                    ...
                    elif "firstoptonly" in newline:
                        if '=' not in line:
                            self.firstoptonly = True
                        else:
                            self.firstoptonly=self.GrabBoolValue(a)
