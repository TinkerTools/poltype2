        ...
        for ff in filelist:
            ...
            if '.key_5' in ff:
                ...
                for lineidx in range(len(results)):
                    ...
                    if 'torsion' in line and '#' not in line and 'Missing' not in line and vdwfragment==False:
